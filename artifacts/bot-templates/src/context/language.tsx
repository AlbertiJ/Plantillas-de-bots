...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    navBuilder: "Bot Builder",
    navLibraries: "Libraries",
    navCtfOsint: "CTF / OSINT Panel",
    navCtfTemplates: "Phase 4 — CTF Templates",
    navWatchdog: "Phase 6 — Watchdog 24/7",
  ...
  es: {
    ...
    navBuilder: "Constructor de Bot",
    navLibraries: "Bibliotecas",
    navCtfOsint: "Panel CTF / OSINT",
    navCtfTemplates: "Fase 4 — Plantillas CTF",
    navWatchdog: "Fase 6 — Watchdog 24/7",
