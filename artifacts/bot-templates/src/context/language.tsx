...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    loginLocked: "Account locked. Contact the administrator.",
    loginNoCreds: "Please enter your username and password.",
    loginFirstRunTitle: "First Run — Initial Credentials",
    loginFirstRunDesc: "Use these credentials for your first login. You will be asked to change your password.",
    loginFirstRunUser: "Username:",
    loginFirstRunPass: "Password:",
    loginFirstRunCopy: "Copy",
    loginFirstRunWarning: "This password will NOT be shown again after you log in.",
    loginFirstHint: "Check the API server console for the initial credentials.",

    adminTitle: "Admin Panel",
    adminSubtitle: "Manage your bot panel configuration",
    adminMustChangePwdTitle: "Password Change Required",
    adminMustChangePwdDesc: "For security, you must set a new password before continuing.",
    ...
    adminPwdSave: "Save Password",
    adminPwdChanged: "Password changed successfully.",
    adminPwdFailed: "Failed to change password. Check your current password.",
    ...
    adminPwdGenerate: "Generate",
    adminPwdRotateHint: "Use a strong, unique password. You can generate one automatically.",
    adminTokensTitle: "API Tokens",
    adminTokensSubtitle: "Manage your bot API tokens stored in the server.",
    adminTokensSave: "Save Tokens",
    adminTokensSaved: "Tokens saved successfully.",
    adminTokensError: "Error saving tokens.",
    adminTokensReveal: "Reveal",
    adminTokensHide: "Hide",
    adminTokensFootnote: "Tokens are stored encrypted on the server and never exposed in the frontend source code.",
    adminAccountTitle: "Account Info",
    adminAccountUser: "Username:",
    adminAccountId: "Account ID:",
    adminAccountCreated: "Created:",
    adminAccountUpdated: "Last updated:",
    adminLockTitle: "Session",
    adminLockHint: "Sign out from the admin panel.",
  },
  es: {
    ...
    loginLocked: "Cuenta bloqueada. Contactá al administrador.",
    loginNoCreds: "Ingresá tu usuario y contraseña.",
    loginFirstRunTitle: "Primer Arranque — Credenciales Iniciales",
    loginFirstRunDesc: "Usá estas credenciales para el primer inicio de sesión. Se te pedirá cambiar la contraseña.",
    loginFirstRunUser: "Usuario:",
    loginFirstRunPass: "Contraseña:",
    loginFirstRunCopy: "Copiar",
    loginFirstRunWarning: "Esta contraseña NO se volverá a mostrar después de que inicies sesión.",
    loginFirstHint: "Revisá la consola del servidor API para ver las credenciales iniciales.",

    adminTitle: "Panel Administrador",
    adminSubtitle: "Gestioná la configuración de tu panel de bots",
    adminMustChangePwdTitle: "Cambio de Contraseña Requerido",
    adminMustChangePwdDesc: "Por seguridad, debés establecer una nueva contraseña antes de continuar.",
    adminPwdTitle: "Cambiar Contraseña",
    adminPwdCurrent: "Contraseña Actual",
    adminPwdNew: "Nueva Contraseña",
    adminPwdConfirm: "Confirmar Nueva Contraseña",
    adminPwdSave: "Guardar Contraseña",
    adminPwdChanged: "Contraseña cambiada correctamente.",
    adminPwdFailed: "Error al cambiar la contraseña. Verificá la contraseña actual.",
    ...
    adminPwdGenerate: "Generar",
    adminPwdRotateHint: "Usá una contraseña segura y única. Podés generar una automáticamente.",
    adminTokensTitle: "Tokens de API",
    adminTokensSubtitle: "Gestioná los tokens de API de tus bots guardados en el servidor.",
    adminTokensSave: "Guardar Tokens",
    adminTokensSaved: "Tokens guardados correctamente.",
    adminTokensError: "Error al guardar los tokens.",
    adminTokensReveal: "Mostrar",
    adminTokensHide: "Ocultar",
    adminTokensFootnote: "Los tokens se guardan cifrados en el servidor y nunca se exponen en el código fuente del frontend.",
    adminAccountTitle: "Info de Cuenta",
    adminAccountUser: "Usuario:",
    adminAccountId: "ID de cuenta:",
    adminAccountCreated: "Creado:",
    adminAccountUpdated: "Última actualización:",
    adminLockTitle: "Sesión",
    adminLockHint: "Cerrar sesión del panel administrador.",
  },
};
